            ...
            <div class="container fill_height">
              <div class="row fill_height">
                <div class="col-lg-4 col-md-6 fill_height">
                  <a href="product.php?id=<?php echo $row['id']; ?>"><div class="banner_2_content">
                    <div class="banner_2_category"><?php echo $row['category_name']; ?></div>
                    <div class="banner_2_title"><?php echo $row['name']; ?></div>
                    <div class="banner_2_text"><?php echo $row['description']; ?></div>
                    <div class="button banner_2_button"><a href="product.php?id=<?php echo $row['id']; ?>">Afla acum</a></div>
                  </div>
                </div>
          ...
          <div class="deals">
            ...
            <div class="deals_slider_container"> 
              ...
              <div class="owl-carousel owl-theme deals_slider"> 
                ...
                <a href="product.php?id=<?php echo $row['id']; ?>"><div class="owl-item deals_item">
